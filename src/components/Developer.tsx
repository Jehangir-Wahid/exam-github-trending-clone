...
const Developer: React.FC<DeveloperType> = ({
    ...
    return (
        <div>
            <article
                className="Box-row d-flex parent-article"
                id={"pa-" + username}
            >
                <a
                    style={{ width: "16px" }}
                ...
                <div className="d-sm-flex flex-auto">
                                    ...
                                    <h1 className="h4 lh-condensed">
                                        ...
                                        >
                                            <svg
                                                ...
                                                version="1.1"
                                                width="16"
                                                className="octicon octicon-repo color-fg-muted mr-1"
                                            >
                                                <path
                                                    fillRule="evenodd"
                    ...
                    <div className="col-sm-4 d-flex flex-sm-justify-end ml-sm-3 pr-3">
                        <div className="mr-2">
                            <a
                                href="#"
                                className="btn btn-sm btn-block bg-dark"
                            >
                                <svg
                                    aria-hidden="true"
                                    height="16"
                        ...
                        <div className="user-profile-following-container">
                            <div className="user-following-container">
                                <span className="user-following-container js-form-toggle-container">
                                    <form className="js-form-toggle-target">
                                        <input
                                            type="submit"
                                            name="commit"
                                            value="Follow"
